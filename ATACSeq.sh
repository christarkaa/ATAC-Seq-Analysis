...
# Peak calling macs2
macs2 callpeak -t Mapping/SRR24135553.bed -n SRR24135553 -q 0.05 --broad -f BEDPE -g hs -B --keep-dup all --trackline --outdir Peaks
macs2 callpeak -t Mapping/SRR24135554.bed -n SRR24135554 -q 0.05 --broad -f BEDPE -g hs -B --keep-dup all --trackline --outdir Peaks
macs2 callpeak -t Mapping/SRR24135555.bed -n SRR24135555 -q 0.05 --broad -f BEDPE -g hs -B --keep-dup all --trackline --outdir Peaks
macs2 callpeak -t Mapping/SRR24135556.bed -n SRR24135556 -q 0.05 --broad -f BEDPE -g hs -B --keep-dup all --trackline --outdir Peaks
